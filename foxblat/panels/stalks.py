...
from foxblat.hid_handler import MozaHidDevice
...
class StalksSettings(SettingsPanel):
    ...
    def _add_row(self, row: FoxblatRow) -> None:
        super()._add_row(row)
    ...
    def prepare_ui(self):
        ...
        self._add_row(FoxblatSwitchRow("Turn Signals toggle", "Press button again when canceling"))
        ...
        self._add_row(FoxblatSwitchRow("Turn Signals hold", "Hold button as long as signal is active"))
        ...
        self._add_row(FoxblatSwitchRow("Headlights", "Cycling instead of discrete buttons"))
        ...
        self._add_row(FoxblatSwitchRow("Skip positional", "For games that only have on/off headlights"))
        ...
        self._wipers1 = FoxblatSwitchRow("Wipers", "Cycling instead of discrete buttons")
        self._wipers2 = FoxblatSwitchRow("Wipers alternative", "Up/Down instead of discrete buttons")
        ...
        self._quick_wipe = FoxblatSwitchRow("Quick wipe emulation", "One and done")
        ...
        self._add_row(FoxblatSwitchRow("Rear wiper as ignition", "Pretty immersive"))
