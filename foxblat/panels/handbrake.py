...
class HandbrakeSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        row = FoxblatSliderRow("Button threshold", suffix="%")

        self._add_row(FoxblatToggleButtonRow("Handbrake Mode"))
        ...
        self._curve_row = FoxblatEqRow("", 5, suffix="%")
        ...
        self._add_row(FoxblatSliderRow("Range End", suffix="%", value=100))
        self._current_row.add_marks(20, 40, 60, 80)
        self._current_row.set_slider_width(380)
        ...
        self._add_row(FoxblatCalibrationRow("Handbrake Calibration", "Pull handbrake fully once"))
