...
from foxblat.hid_handler import MozaAxis, MozaHidDevice
...
class BaseSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        self._add_row(FoxblatSliderRow(
        ...
        self._add_row(FoxblatSwitchRow("Standby mode"))
        ...
        self._add_row(FoxblatSwitchRow("Force Feedback", subtitle="E-Stop override"))
        self._current_row.reverse_values()
        ...
        self._add_row(FoxblatSliderRow("Base torque output", suffix="%", range_start=50, increment=5))
        ...
        self._add_row(FoxblatSliderRow("Game FFB strength", suffix="%"))
        ...
        self._add_row(FoxblatSliderRow("Maximum Wheel Speed", suffix="%", range_end=200))
        ...
        slider = FoxblatSliderRow("Steering Wheel Inertia", range_start=100, range_end=4000, increment=50)
        mode = FoxblatToggleButtonRow("Protection Mode")

        self._add_row(FoxblatSwitchRow("Hands-Off Protection"))
        ...
        self._add_row(FoxblatSliderRow("Damping Level", suffix="%"))
        ...
        self._add_row(FoxblatSliderRow("Trigger Speed", range_end=400, suffix=" kph   "))
        ...
        self._add_row(FoxblatSliderRow("Wheel Damper", suffix="%"))
        ...
        self._add_row(FoxblatSliderRow("Wheel Friction", suffix="%"))
        ...
        self._add_row(FoxblatSliderRow("Natural Inertia", range_start=100, range_end=500, increment=50))
        ...
        self._add_row(FoxblatSliderRow("Wheel Spring", suffix="%"))
        self._current_row.add_marks(50)
        self._current_row.set_expression("*10")
        self._current_row.set_reverse_expression("/10")
        ...
        self._add_row(FoxblatSliderRow("Game Damper", subtitle="Default = 50%", increment=5, suffix="%"))
        self._current_row.add_marks(25, 50, 75)
        ...
        self._add_row(FoxblatSliderRow("Game Friction", subtitle="Default = 50%", increment=5, suffix="%"))
        self._current_row.add_marks(25, 50, 75)
        self._current_row.set_expression("*2.55")
        self._current_row.set_reverse_expression("/2.55")
        ...
        self._add_row(FoxblatSliderRow("Game Inertia", subtitle="Default = 50%", increment=5, suffix="%"))
        self._current_row.add_marks(25, 50, 75)
        self._current_row.set_expression("*2.55")
        self._current_row.set_reverse_expression("/2.55")
        ...
        self._add_row(FoxblatSliderRow("Game Spring", subtitle="Default = 100%", increment=5, suffix="%"))
        self._current_row.add_marks(25, 50, 75)
        self._current_row.set_expression("*2.55")
        self._current_row.set_reverse_expression("/2.55")
        ...
        self._add_row(FoxblatSliderRow("Soft Limit Stiffness", range_start=1, range_end=10))
        ...
        self._add_row(FoxblatToggleButtonRow("Soft Limit Strength"))
        ...
        self._add_row(FoxblatSwitchRow("Soft Limit Retain Game FFB"))
        ...
        self._add_row(FoxblatSwitchRow("Base Status Indicator"))
        ...
        # self._add_row(FoxblatSwitchRow("Default Work Mode State"))
        # self._current_row.reverse_values()
        ...
        self._add_row(FoxblatToggleButtonRow("Temperature Control Strategy",))
        ...
        tmp1 = FoxblatComboRow("Select music")
        tmp1.set_active(0)
        for i in range(10):
        ...
        tmp2 = FoxblatButtonRow("Preview", "Play")
        tmp2.set_active(0)
        tmp2.subscribe(lambda v: self._cm.set_setting(tmp1.get_value() + 1, "base-music-preview"))

        tmp3 = FoxblatSliderRow("Volume", subtitle="Very loud over 20")
        ...
        self._add_row(FoxblatSwitchRow("Startup music enabled"))
        ...
        self._add_row(FoxblatLabelRow("MCU Temperature"))
        ...
        self._add_row(FoxblatLabelRow("MOSFET Temperature"))
        self._current_row.set_suffix("°C")
        self._current_row.set_reverse_expression("/100")
        self._cm.subscribe("base-mosfet-temp", self._current_row.set_value)

        self._add_row(FoxblatLabelRow("Motor Temperature"))
        self._current_row.set_suffix("°C")
        self._current_row.set_reverse_expression("/100")
    ...
    def __prepare_eq(self):
        ...
        self.add_preferences_group()
        self._eq_row = FoxblatEqRow("FFB Equalizer", 6,
        ...
        self.add_preferences_group()
        self._sensitivity_row = FoxblatSliderRow("Road Sensitivity", range_end=10)
        ...
        self._add_row(FoxblatSliderRow("FFB interpolation", 0, 10, subtitle="Mostly causes issues"))
    ...
    def __prepare_curve(self):
        ...
        self.add_preferences_group()
        self._curve_row = FoxblatEqRow("FFB Curve", 5, subtitle="Game FFB to Output FFB ratio", suffix="%")
        ...
        self.add_preferences_group()
        self._add_row(FoxblatSliderRow("Stronger around center", subtitle="Offsets first curve point to the left", range_end=18))
        ...
        self._add_row(FoxblatSwitchRow("Force Feedback Reversal"))
