...
class DashSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        self._add_row(FoxblatToggleButtonRow("Flags Indicator"))
        ...
        self._add_row(FoxblatNewColorPickerRow(pickers=6))
        ...
        self.add_preferences_group()
        self._add_row(FoxblatButtonRow("Dash indicator test", "Test"))
