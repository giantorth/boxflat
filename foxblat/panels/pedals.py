...
from foxblat.hid_handler import MozaAxis, AxisData
...
class PedalsSettings(SettingsPanel):
    def __init__(self, button_callback, connection_manager: MozaConnectionManager, hid_handler):
        ...
        self._curve_rows: dict[str, FoxblatEqRow] = {}
    ...
    def _prepare_pedal(self, pedal: AxisData):
        ...
        self._curve_rows[pedal.name] = FoxblatEqRow("", 5, suffix="%")
        ...
        self._add_row(FoxblatSliderRow("Range Start", suffix="%"))
        self._current_row.add_marks(20, 40, 60, 80)
        ...
        self._add_row(FoxblatSliderRow("Range End", suffix="%"))
        self._current_row.add_marks(20, 40, 60, 80)
        self._current_row.set_slider_width(380)
        ...
        if pedal == MozaAxis.BRAKE:
            self._add_row(FoxblatSliderRow("Sensor ratio", suffix="%", subtitle="0% = Only Angle Sensor\n100% = Only Load Cell"))
        ...
        self._add_row(FoxblatSwitchRow("Reverse Direction"))
        ...
        self._add_row(FoxblatCalibrationRow("Calibration", f"Fully depress {pedal.name} once"))
