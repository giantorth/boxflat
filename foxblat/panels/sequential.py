...
class SequentialSettings(SettingsPanel):
    ...
    def prepare_ui(self):
        ...
        self._add_row(FoxblatSwitchRow("Reverse Shift Direction"))
        ...
        self._add_row(FoxblatSwitchRow("Paddle Shifter Synchronization", subtitle="Use the same buttons as paddle shifters. Works with USB now!"))
        ...
        self._add_row(FoxblatSliderRow("Buttons Brightness", 0, 10))
        ...
        self._S1 = FoxblatColorPickerRow("S1 Color")
        self._add_row(self._S1)

        self._S2 = FoxblatColorPickerRow("S2 Color")
    ...
    def _filter_data(self, value, row: FoxblatRow):
        if not self._active:
            return
        row.set_value(value)
